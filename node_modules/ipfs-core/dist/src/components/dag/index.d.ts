export class DagAPI {
    ...
    export: (root: import("ipfs-http-client").CID, options?: import("ipfs-core-types/src/dag/index.js").ExportOptions | undefined) => AsyncIterable<Uint8Array>;
    get: (cid: import("ipfs-http-client").CID, options?: import("ipfs-core-types/src/dag/index.js").GetOptions | undefined) => Promise<import("ipfs-core-types/src/dag/index.js").GetResult>;
    ...
    put: (dagNode: any, options?: import("ipfs-core-types/src/dag/index.js").PutOptions | undefined) => Promise<import("ipfs-http-client").CID>;
}
