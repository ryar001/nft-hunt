...
export class BitswapAPI {
    ...
    wantlistForPeer: (peerId: import("@libp2p/interface-peer-id").PeerId, options?: import("ipfs-core-types/src/utils").AbortOptions | undefined) => Promise<import("multiformats/cid").CID[]>;
    ...
    stat: (options?: import("ipfs-core-types/src/utils").AbortOptions | undefined) => Promise<import("ipfs-core-types/src/bitswap/index.js").Stats>;
}
