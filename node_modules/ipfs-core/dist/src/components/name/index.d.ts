export class NameAPI {
    ...
    publish: (value: string | import("ipfs-http-client").CID, options?: import("ipfs-core-types/src/name/index.js").PublishOptions | undefined) => Promise<import("ipfs-core-types/src/name/index.js").PublishResult>;
