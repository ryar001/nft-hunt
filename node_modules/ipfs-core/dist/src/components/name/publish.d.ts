...
}): (value: string | import("ipfs-http-client").CID, options?: import("ipfs-core-types/src/name").PublishOptions | undefined) => Promise<import("ipfs-core-types/src/name").PublishResult>;
