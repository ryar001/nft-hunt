export class BootstrapAPI {
    ...
    add: (multiaddr: import("@multiformats/multiaddr").Multiaddr, options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<{
        Peers: import("@multiformats/multiaddr").Multiaddr[];
    }>;
    list: (options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<{
        Peers: import("@multiformats/multiaddr").Multiaddr[];
    }>;
    rm: (multiaddr: import("@multiformats/multiaddr").Multiaddr, options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<{
        Peers: import("@multiformats/multiaddr").Multiaddr[];
    }>;
