...
export function createDht({ network, repo, peerId }: {
    ...
    query: (peerId: CID | import("@libp2p/interface-peer-id").PeerId, options?: import("ipfs-core-types/src/utils").AbortOptions | undefined) => AsyncIterable<import("ipfs-core-types/src/dht").QueryEvent>;
};
