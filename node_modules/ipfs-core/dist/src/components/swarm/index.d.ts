export class SwarmAPI {
    ...
    disconnect: (addr: import("@libp2p/interface-peer-id").PeerId | import("@multiformats/multiaddr").Multiaddr, options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<void>;
