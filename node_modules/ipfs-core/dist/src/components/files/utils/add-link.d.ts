 ...
 */
export function addLink(context: MfsContext, options: {
    cid: CID;
    name: string;
    size: number;
    ...
    parent?: import("@ipld/dag-pb/src/interface.js").PBNode | undefined;
}): Promise<import("./dir-sharded.js").ImportResult>;
