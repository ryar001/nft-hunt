...
import type { PubSub, Message, StrictNoSign, StrictSign, PubSubInit, PubSubEvents, PeerStreams, PubSubRPCMessage, PubSubRPC, PubSubRPCSubscription, PublishResult } from '@libp2p/interface-pubsub';
...
export declare abstract class PubSubBaseProtocol<Events extends {
    [s: string]: any;
} = PubSubEvents> extends EventEmitter<Events> implements PubSub<Events>, Initializable {
    started: boolean;
    /**
     ...
     */
    getMsgId(msg: Message): import("multiformats/hashes/hasher.js").Await<Uint8Array>;
    /**
